...
<div class="home-container">
    <h1>Cinema System</h1>
    <h2>Management Staff Home</h2>

    <p class="welcome-user"><%= user.getName() %></p>

    <div class="button-group">

        <form action="${pageContext.request.contextPath}/view/managementStaff/StatsView.jsp">
            <button type="submit" name="btnViewStats" class="action-button">
                View Statistics
            </button>
        </form>
